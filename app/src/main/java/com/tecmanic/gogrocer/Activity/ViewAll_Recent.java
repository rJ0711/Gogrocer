                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            CartModel recentData = new CartModel(product_id, product_name, description, pprice, quantity + " " + unit, product_image, sessionManagement.getCurrency() + totalOff + " " + "Off", mmrp, count, unit);
